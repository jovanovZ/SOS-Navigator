...
router.get(
  "/findAllLocationsInRadius",
  locationController.findAllLocationsInRadius
);
...
router.get(
  "/getSomeStationsInRadius",
  locationController.findSomeStationsInRadius
);
//localhost:3002/api/location/getSomeStationsInRadius?long=40.5058&lat=46.0569&radius=5000&n=2

router.get(
  "/getAllAccidentsInRadius",
  locationController.findAllAccidentsInRadius
);
